...
#------------------------------------------------------------------------------
# PROGRAM: rbeast-frontend-runnable-rpy2-subset.py
#
# RUN SYNTAX: python rbeast-frontend-runnable-rpy2-subset.py subset.txt stationcode 
#------------------------------------------------------------------------------
# Version 0.1
# 18 February, 2021
# Michael Taylor
...
#   path = "~/Documents/REPOS/rbeast-frontend/"
    path = ""
