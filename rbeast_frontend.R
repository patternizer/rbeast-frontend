...
dg <- read.csv(file="dg.csv", head=TRUE, sep=",", stringsAsFactors=F, na.string="")
...
write.csv(out_trend_order, "out_trend_order.csv", row.names=FALSE)
write.csv(out_trend_cp, "out_trend_cp.csv", row.names=FALSE)
write.csv(out_seasonal, "out_seasonal.csv", row.names=FALSE)
write.csv(out_seasonal_prob, "out_seasonal_prob.csv", row.names=FALSE)
write.csv(out_seasonal_CI, "out_seasonal_CI.csv", row.names=FALSE)
write.csv(out_seasonal_order, "out_seasonal_order.csv", row.names=FALSE)
write.csv(out_seasonal_cp, "out_seasonal_cp.csv", row.names=FALSE)
